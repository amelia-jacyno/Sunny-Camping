...
<html>
<head>
    <title>Słoneczny Camping - Wicie - Pole namiotowe i domki</title>
    <meta charset="UTF-8">
...
<body>
<header>
    <div class="parallax_nav parallax-window" data-parallax="scroll" data-image-src="images/bgsc.jpg">
        <a class="navbar_logo navbar-brand" href="#"><img alt="Nadmorski Sonet" src="images/sloneczny_camping.png"></a>
...
<main>
    ...
    <div id="pole" class="camping_section parallax-window" data-parallax="scroll" data-image-src="images/pole.jpg">
...
<footer>
    <div class="container">
        ...
        <div class="pull-left">
            <span>Copyright <i class="fa fa-copyright" aria-hidden="true"></i> 2017</span><a target="_blank"
                                                                                             href="http://www.nadmorskisonet.pl"><img
                    class="sc_img" src="images/sloneczny_camping.png"></a>
        </div>
    </div>
</footer>
